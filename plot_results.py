...
plt.plot(N, S, label = 'exponentially distributed weights scale 1')
N, M, S = read_file('data/precision_exponential_weights_scale_100.txt')
plt.plot(N, S, label = 'exponentially distributed weights scale 100')
plt.yscale('log')
plt.legend()
